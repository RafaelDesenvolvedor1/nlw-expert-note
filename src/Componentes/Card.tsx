...
export function Card({date, content, id,onNoteDeleted}: CardProps){
    return(
        <Dialog.Root>
            <Dialog.Trigger className="rounded-md flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 text-left hover:ring-slate-600  focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
